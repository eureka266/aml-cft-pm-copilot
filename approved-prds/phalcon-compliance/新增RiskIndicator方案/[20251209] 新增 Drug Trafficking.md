# \[20251209\] 新增 Drug Trafficking

| Risk Indicator | 指标描述 | 风险等级 | 推荐配置方案 |
| --- | --- | --- | --- |
| **Drug Trafficking** | 指的是参与毒品非法生产、运输或分销的实体（例如个人、团体或组织）。 | **Critical** | 加入默认引擎：<br>*   “FATF Guidelines: Wallet owned by illicit entity”<br>    <br>*   “Transaction Involving Illicit Entities”<br>    <br>*   “FATF Guidelines: Exposure to illicit entity”<br>    <br>*   “Transaction Exposed to Illicit Entities” |
...
:::
仅对付费用户发送此提醒，即 Starter 及以上订阅用户，加上 Enterprise 的正式用户。

对 Free 及 Enterprise 试用用户，直接修改 Engine，不通知。
:::
...
| --- | --- | --- |
| Drug Trafficking | Addresses linked to entity (such as a person, group, or organization) that is involved in the illegal production, transportation, or distribution of drugs. | Add this indicator to default risk engines:<br>FATF Guidelines: Wallet owned by illicit entity<br>Transaction Involving Illicit Entities<br>FATF Guidelines: Exposure to illicit entity<br>Transaction Exposed to Illicit Entities |

**Note:** If no action is taken by **December 19, 2025**, the recommended setup will be applied automatically.
...
**Subject**: 🔔 \[Action Required\] New Risk Indicator Added – Confirm Setup by December 19, 2025
...
| --- | --- | --- |
| FATF Guidelines: Wallet owned by illicit entity | Address / Entity Risk | 增加 Risk Indicator：Drug Trafficking |
| FATF Guidelines: Exposure to illicit entity | Address / Interaction Risk | 增加 Risk Indicator：Drug Trafficking |
| Transaction Involving Illicit Entities | Transaction / Participant Risk | 增加 Risk Indicator：Drug Trafficking |
| Transaction Exposed to Illicit Entities | Transaction / Interaction Risk | 增加 Risk Indicator：Drug Trafficking |
...
若系统无法找到对应的默认引擎（可能因用户删除或重命名），弹窗提示：